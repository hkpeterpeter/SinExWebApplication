...
using SinExWebApplication.Models;

namespace SinExWebApplication.Controllers
{
    public class DestinationsController : Controller
    {
        ...
        {
            return View(PopulateDestinations());
        }


        private List<Destination> PopulateDestinations()
        {
